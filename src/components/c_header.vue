<template>
  <header class="header padding">
    ...
    <div class="account">
      <span class="s">{{ this.$store.getters.getUserData.name }}</span>
      <div class="account__wrapp">
        <img
          class="avatar"
          v-if="this.$store.getters.getUserData.avatar == undefined"
          src="/img/person.svg"
          alt=""
        />
        <img
          class="avatar"
          v-else
          :src="this.$store.getters.getUserData.avatar"
          alt=""
        />
      </div>
    </div>
